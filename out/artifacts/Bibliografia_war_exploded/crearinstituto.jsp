    ...
    <form method="get" action="crearInstituto" name="frmnuevo" id="frm_nuevo">
        <div class="row">
            <div class="col s4">
                ...
                <input type="text" name="clave_inst" placeholder="Clave Instituto"/>
            </div>
            <div class="col s4">
                <label>Nombre del Instituto</label>
                <input type="text" name="nombre_inst" placeholder="Nombre del Instituto"/>
            </div>
            <div class="col s4">
                <label>Direccion del Instituto</label>
                <input type="text" name="direccion_inst" placeholder="Direccion del Instituto"/>
            </div>
        </div>
