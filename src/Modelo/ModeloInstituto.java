...
public class ModeloInstituto extends Conexion {
    ...
    public ArrayList<Instituto> getAllProductos(){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(asign.crear_instituto(new Instituto("123", "Afropecuario N.15", "AV. Lazaro Cardenaz")));

        for(Instituto a : asign.getAllProductos()) {
            System.out.println(a.getNombreInst());
        }
    }
}